...
export interface NftWalletReadOnlyInterface {
  ...
  getBlacklist: () => Promise<BlacklistResponse>;
}
...
export class NftWalletClient
  extends NftWalletQueryClient
  implements NftWalletInterface
{
